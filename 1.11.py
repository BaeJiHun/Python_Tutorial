...
today = int(input(("오늘의 요일을 입력하세요:")))
over = eval(input("오늘부터 경과한 일수를 입력하세요:"))
future = today + over
weekends = {0:"일요일", 1:"월요일", 2:"화요일", 3:"수요일", 4:"목요일" , 5:"금요일", 6:"토요일"}
answer = print("오늘은 {0}이고 미래의 요일은 {1} 입니다.".format(weekends[today],weekends[future - 7*(future // 7)]))